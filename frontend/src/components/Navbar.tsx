                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    {isCompanyMenuOpen && (
                        <div id="mega-menu-full-dropdown"
                             className="absolute left-1/2 top-full mt-2 w-64 transform -translate-x-1/2 z-50 border-gray-200 shadow-sm bg-gray-50 md:bg-white border-y dark:bg-gray-800 dark:border-gray-600">
                            <div
