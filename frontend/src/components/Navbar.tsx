            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900 relative">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="/placeholder.logo.svg" className="h-24 rounded-full" alt="Flowbite Logo" />
                    ...
                    <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                        <button
                            type="button"
                            className="flex text-sm bg-gray-800 rounded-full md:me-0 dark:focus:ring-gray-600"
                        ...
                        {isUserMenuOpen && (
                            <div
                                className="absolute top-full right-0 mt-2 w-48 z-50 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                            >
                                <div className="px-4 py-3">
                                    <span className="block text-sm text-gray-900 dark:text-white">User's Name</span>
                                    <span className="block text-sm text-gray-500 truncate dark:text-gray-400">users@email.com</span>
                                </div>
                                <ul className="py-2">
                                    <li>
                    ...
                    {isCompanyMenuOpen && (
                        <div id="mega-menu-full-dropdown" className="absolute left-1/2 top-full mt-2 w-64 transform -translate-x-1/2 z-50 border-gray-200 shadow-sm bg-gray-50 md:bg-white border-y dark:bg-gray-800 dark:border-gray-600">
